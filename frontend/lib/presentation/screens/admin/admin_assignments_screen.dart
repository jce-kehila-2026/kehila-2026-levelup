...
class _AdminAssignmentsScreenState extends State<AdminAssignmentsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_errorMessage.isNotEmpty) {
      return Scaffold(
        appBar: AppBar(title: const Text('Group Assignments')),
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Group Assignments', style: TextStyle(color: AppColors.text, fontSize: 16, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ...
      body: SafeArea(
        child: _assignments.isEmpty
            ? const Center(child: Text('No assignments found.', style: TextStyle(color: AppColors.mutedForeground)))
            : ListView.builder(
                          ...
                          Row(
                            children: [
                              BadgeWidget(
                                ...
                                variant: a.type == 'central' ? BadgeVariant.info : BadgeVariant.defaultVariant,
                              ),
